...
def search_news(company, page=1):
    ...
    f"{company} strategic partnerships OR collaborations OR joint ventures",
    f"{company} AI initiatives OR artificial intelligence OR machine learning projects",
    f"{company} market strategy OR go-to-market OR business model changes",
    f"{company} international expansion OR new markets OR global presence",
    f"{company} product launch OR fleet update OR new offerings",
    f"{company} infrastructure investment OR capital expenditure OR funding OR datacenter OR manufacturing facility",
    f"{company} technology innovation OR digital transformation OR software development",
    f"{company} mergers OR acquisitions OR stake purchase",
    f"{company} funding round OR series A B C OR IPO OR investment raised"
    ]
